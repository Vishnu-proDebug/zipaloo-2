...
namespace AIMHEAD_ON_OFF
{
    public partial class Form1 : Form
    {
        ...
        private async void LoadAddressesClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (addresses == null || !addresses.Any())
                {
                    ...
                    MessageBox.Show("Pattern not found in game memory. Make sure:\n1. The pattern is correct\n2. Game is running\n3. HD-Player process is active", "Pattern Not Found", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
        ...
        /// <summary>
        /// ✅ NO RECOIL FUNCTION - Added from zipaloo
        /// Applies NO RECOIL patch to the game
        /// </summary>
        private async void NoRecoil_Click(object sender, EventArgs e)
        {
